...
#     # ---------------------------
#     # 6) Draw base keypoints output
#     # ---------------------------
#     annotated = results[0].plot()

#     # ---------------------------
#     # 7) Extract keypoints and draw numbers + skeleton
#     # ---------------------------
#     if results[0].keypoints is not None:
#         kpts = results[0].keypoints.xy  # (num_objects, num_keypoints, 2)

#         for obj_kpts in kpts:
#             # obj_kpts: (num_keypoints, 2)

#             # ✅ Draw keypoint numbers
#             for idx, (x, y) in enumerate(obj_kpts):
#                 x, y = int(x), int(y)

#                 # Draw small circle (optional, makes point clearer)
#                 cv2.circle(annotated, (x, y), 4, (0, 0, 255), -1)

#                 # Draw index number near keypoint
#                 cv2.putText(
#                     annotated,
#                     str(idx),
#                     (x + 5, y - 5),   # offset so text doesn't overlap point
#                     FONT,
#                     FONT_SCALE,
...
#     # 8) Show output
#     # ---------------------------
#     cv2.imshow("Goat Pose Estimation with Skeleton + Index", annotated)
